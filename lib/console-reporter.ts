...
export class DefaultReporterImp implements plugin.PluginReporter {
  ...
  public constructor(logger: plugin.PluginReporterLogger, standardConsole: ReporterStandardConsole, util: Util) {
    this.logger = logger;
...
export function createPlugin(): plugin.PluginReporter {
  return new DefaultReporterImp(console, createReporterStandardConsole(), createUtil());
}
